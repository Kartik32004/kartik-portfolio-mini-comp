...
const SoftwareProjects: React.FC<SoftwareProjectsProps> = (props) => {
    return (
        <div className="site-page-content">
            ...
            <br />
            <p>
                Here's a showcase of my most impactful technical contributions—demonstrating my ability to design, develop, and deploy production-ready solutions in AI, cybersecurity, and cloud infrastructure.
            </p>
            <br />
            <ResumeDownload />
            <br />
            ...
            <div className="text-block">
                <h2>AI-Powered Fitness Coach & Posture Analysis</h2>
                <br />
                <p>
                    Developed an intelligent fitness coaching platform using <b>MediaPipe</b>, <b>OpenCV</b>, and <b>TensorFlow</b> for real-time posture detection and correction. Achieved <b>85%+ model accuracy</b> across varied poses and reduced form correction feedback delay by <b>70%</b>. Leveraged <b>Next.js</b> and <b>Firebase</b> for seamless frontend-backend integration, cloud data storage, and user analytics. Tested with 20+ users, demonstrating a <b>60% improvement</b> in workout form retention and session consistency. This project honed my computer vision, deep learning, and full-stack development skills.
                </p>
                <br />
                <div className="captioned-image">
                    <iframe
                        width="100%"
                        height="315"
                        src="https://www.youtube.com/embed/YiPUTCamF2M"
                        title="Fitness Demo"
                        frameBorder="0"
                    ...
                    <p style={styles.caption}>
                        <sub>
                            <b>Figure 1:</b> Real-time AI-driven posture detection using webcam and TensorFlow models. <br/>
                            <a href="https://github.com/Anugrah0619/Fitness/tree/Kartik/fitness-website" target="_blank" rel="noreferrer">
                                [GitHub Repository]
                            </a>
                        </sub>
                    </p>
            ...
            <div className="text-block">
                <h2>DDoS Prevention & Honeypot Redirection System</h2>
                <br />
                <p>
                    Created a dynamic DDoS mitigation system for the <b>Smart India Hackathon 2024 (DRDO)</b> problem statement. Utilized <b>AWS Lambda</b>, <b>Zeek</b>, <b>Fortinet Firewall</b>, and <b>Splunk</b> to build an automated honeypot redirection pipeline. Reduced server payload from malicious traffic by <b>60%</b> and ensured uptime for 1K+ concurrent sessions. Implemented tiered lockouts after 5 failed logins with progressive timeout up to 20 minutes. This project reinforced my skills in cloud security, intrusion detection systems, and automated server-side resilience architecture.
                </p>
                <br />
                <div className="captioned-image">
                    <iframe
                        width="100%"
                        height="315"
                        src="https://www.youtube.com/embed/gI8LnMAhBv8?si=l_GwWwEjfbbvvKPs"
                        title="Honeypot Demo"
                        frameBorder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowFullScreen
                    ...
                    <p style={styles.caption}>
                        <sub>
                            <b>Figure 2:</b> Honeypot defense flow isolating and rerouting suspicious users using Zeek and AWS.
                        </sub>
                    </p>
                </div>
            </div>
            ...
            <div className="text-block">
                <h2>AICTE GenAI Virtual Internship</h2>
                <br />
                <p>
                    Completed AICTE’s national-level internship on <b>Generative AI</b> with a focus on LLMs, transformers, and prompt engineering. Built text generation, summarization, and chatbot prototypes using <b>Google Vertex AI</b> and <b>Hugging Face Transformers</b>. Achieved <b>90%+ performance accuracy</b> in model fine-tuning exercises and ranked in the <b>top 10%</b> of over 25K+ interns. Strengthened my expertise in cloud ML platforms, ethical AI use, and low-code prototyping.
                </p>
            </div>

            <div className="text-block">
                <h2>CISCO Skill-a-thon Internship – CCNA</h2>
                <br />
                <p>
                    Gained hands-on exposure to <b>network design, IP addressing, routing, and switching</b> under SAKEC’s CISCO Skill-a-thon. Configured and diagnosed real-world scenarios using <b>Packet Tracer</b>, reducing lab errors by <b>80%</b> by applying subnetting and protocol best practices. Completed the course with a final assessment ranking in the <b>top 15%</b> of the cohort, strengthening my foundational cybersecurity and infrastructure knowledge.
                </p>
            </div>
